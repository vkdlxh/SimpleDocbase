...
public class AttributedTextFormItem: FormItem {
	...
	@discardableResult
	public func title(_ title: String, _ attributes: [NSAttributedStringKey: AnyObject]? = nil) -> Self {
	...
	@discardableResult
	public func value(_ value: String, _ attributes: [NSAttributedStringKey: AnyObject]? = nil) -> Self {
